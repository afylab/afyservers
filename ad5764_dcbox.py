...
##    @setting(200,voltage='v',returns='s')
##    def set_0(self,c,voltage):
##        dev=self.selectedDevice(c)
##        ans = yield dev.set_voltage(0,voltage)
##        returnValue(ans)
##    @setting(201,voltage='v',returns='s')
##    def set_1(self,c,voltage):
##        dev=self.selectedDevice(c)
##        ans = yield dev.set_voltage(1,voltage)
##        returnValue(ans)
##    @setting(202,voltage='v',returns='s')
##    def set_2(self,c,voltage):
##        dev=self.selectedDevice(c)
##        ans = yield dev.set_voltage(2,voltage)
##        returnValue(ans)
##    @setting(203,voltage='v',returns='s')
##    def set_3(self,c,voltage):
##        dev=self.selectedDevice(c)
##        ans = yield dev.set_voltage(3,voltage)
##        returnValue(ans)
##    @setting(204,voltage='v',returns='s')
##    def set_4(self,c,voltage):
##        dev=self.selectedDevice(c)
##        ans = yield dev.set_voltage(4,voltage)
##        returnValue(ans)
##    @setting(205,voltage='v',returns='s')
##    def set_5(self,c,voltage):
##        dev=self.selectedDevice(c)
##        ans = yield dev.set_voltage(5,voltage)
##        returnValue(ans)
##    @setting(206,voltage='v',returns='s')
##    def set_6(self,c,voltage):
##        dev=self.selectedDevice(c)
##        ans = yield dev.set_voltage(6,voltage)
##        returnValue(ans)
##    @setting(207,voltage='v',returns='s')
##    def set_7(self,c,voltage):
##        dev=self.selectedDevice(c)
##        ans = yield dev.set_voltage(7,voltage)
##        returnValue(ans)
