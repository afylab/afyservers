...
class DAC_ADCServer(DeviceServer):
    ...
    @setting(121,kp='v[]',ki='v[]',vmin='v[]',vmax='v[]',setpt='v[]',offset='v[]',iterations='i',threshold='v[]',channel_sig='i',channel_x1='i',channel_y1='i',channel_x3='i',channel_fb='i',dwell='v[]',window='i',set_window='i')
    def run_feedback(self,c,kp,ki,vmin,vmax,setpt,offset,iterations,threshold,channel_sig,channel_x1,channel_y1,channel_x3,channel_fb,dwell,window,set_window):
      """
      Runs the feedback-control loop.
      """
      dev=self.selectedDevice(c)
      yield dev.write("FEEDBACK,%f,%f,%f,%f,%f,%f,%i,%f,%i,%i,%i,%i,%i,%f,%i,%i\r"%(kp,ki,vmin,vmax,setpt,offset,iterations,threshold,channel_sig,channel_x1,channel_y1,channel_x3,channel_fb,dwell,window,set_window))
